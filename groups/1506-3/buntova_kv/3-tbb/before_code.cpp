...
int main(int argc, char * argv[])
{
	...
	freopen_s(&stream, "8.ans", "wb", stdout);
	...
	freopen_s(&stream, "8_omp.ans", "wb", stdout);
	...
	double time_tbb = omp_get_wtime();
	double res_tbb = solver_par_tbb(a, b, c, z, 50, n);
	time_tbb = omp_get_wtime() - time_tbb;

	freopen_s(&stream, "8_tbb.ans", "wb", stdout);
