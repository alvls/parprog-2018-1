...
int main(int argc, char * argv[]) {
	...
	// создаём равномерное распределение случайной величины типа double в диапазоне // [0, 25] 
	uniform_real_distribution <double> distribution(0, 25);				// Функция которую я использую для возведения числа в степень
